...
print("""### 2) Solar Chat API Client 생성하기
...
print("""### 3) Solar Chat API 사용해보기 (선택)
...
print("""## 1. Solar Chat API 요약 성능 확인하기
...
print("""Train Dataset을 이용하여 요약이 잘 되는지 확인해 봅니다.""")
...
print("""Validation Dataset을 이용하여 요약을 진행하고, 성능을 평가해 봅니다.""")
...
print("""다른 방식으로 Few-shot sample을 제공하여 Prompt를 구성해 봅니다.""")
...
print("""### (선택) 변경된 Prompt로 test dataset에 대한 요약을 진행합니다.
